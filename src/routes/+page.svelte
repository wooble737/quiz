<!-- Removed <html>, <head>, and <body> tags for Svelte compatibility -->
<div class="gradient-bg min-h-full">
    ...
    <div id="landingPage" class="min-h-full">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                <div class="quiz-icon inline-block mb-8">
                    <svg class="w-24 h-24 mx-auto text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                </div>
                <h1 class="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
                    Create Amazing
                    <span class="block text-indigo-600">Quizzes</span>
                </h1>
                <p class="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
                    Build engaging quizzes, surveys, and assessments in minutes. No coding required. 
                    Perfect for educators, trainers, and businesses.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button on:click={showAuthForms} class="bg-indigo-600 text-white hover:bg-indigo-700 px-8 py-4 rounded-lg text-lg font-semibold transition-colors shadow-lg">
                        Start Creating Free
                    </button>
                    <button on:click={scrollToFeatures} class="border-2 border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
                        Learn More
                    </button>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="bg-white bg-opacity-30 rounded-lg p-6">
                    <div class="text-4xl font-bold text-indigo-600 mb-2">50K+</div>
                    <div class="text-gray-800 text-lg">Quizzes Created</div>
                </div>
                <div class="bg-white bg-opacity-30 rounded-lg p-6">
                    <div class="text-4xl font-bold text-indigo-600 mb-2">1M+</div>
                    <div class="text-gray-800 text-lg">Quiz Responses</div>
                </div>
                <div class="bg-white bg-opacity-30 rounded-lg p-6">
                    <div class="text-4xl font-bold text-indigo-600 mb-2">10K+</div>
                    <div class="text-gray-800 text-lg">Happy Users</div>
                </div>
            </div>
        </div>

        <!-- Features Section -->
        <div id="featuresSection" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Everything You Need</h2>
                <p class="text-xl text-gray-700 max-w-2xl mx-auto">
                    Powerful features to create, share, and analyze your quizzes
                </p>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    <div class="bg-indigo-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Drag & Drop Builder</h3>
                    <p class="text-gray-700">Create quizzes effortlessly with our intuitive visual editor</p>
                </div>
                ...
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Multiple Question Types</h3>
                    <p class="text-gray-700">Multiple choice, true/false, short answer, and more</p>
                </div>
                ...
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    ...
                    <p class="text-gray-700">Track performance and get detailed insights instantly</p>
                </div>
                ...
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    ...
                    <p class="text-gray-700">Share via link, embed, or social media with one click</p>
                </div>
                ...
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    ...
                    <p class="text-gray-700">Your data is protected with enterprise-grade security</p>
                </div>
                ...
                <div class="bg-white bg-opacity-40 rounded-xl p-8 text-center hover:bg-opacity-60 transition-all">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800 mb-4">Schedule & Automate</h3>
                    <p class="text-gray-700">Set time limits, deadlines, and automatic grading</p>
                </div>
            </div>
        </div>
        ...
        <!-- CTA Section -->
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="bg-white bg-opacity-40 rounded-2xl p-12 text-center">
                <h2 class="text-4xl font-bold text-gray-800 mb-4">Ready to Get Started?</h2>
                <p class="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
                    Join thousands of educators and businesses creating engaging quizzes with QuizCraft
                </p>
                <button on:click={showAuthForms} class="bg-indigo-600 text-white hover:bg-indigo-700 px-8 py-4 rounded-lg text-lg font-semibold transition-colors shadow-lg">
    ...
    <!-- Auth Forms Page -->
    <div id="authPage" class="min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 hidden">
        <!-- Back Button -->
        <div class="max-w-md mx-auto mb-4">
            <button on:click={showLanding} class="flex items-center text-gray-800 hover:text-gray-600 transition-colors">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
            <div class="quiz-icon inline-block">
                <svg class="w-16 h-16 mx-auto text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                </svg>
            </div>
            <h1 class="text-4xl font-bold text-gray-800 mb-2">QuizCraft</h1>
            <p class="text-xl text-gray-700">Create engaging quizzes in minutes</p>
        </div>

        <!-- Auth Forms Container -->
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 card-shadow sm:rounded-lg sm:px-10">
                <!-- Toggle Buttons -->
                <div class="flex mb-6 bg-gray-100 rounded-lg p-1">
                    <button id="loginTab" class="flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors bg-white text-indigo-600 shadow-sm">
                        Sign In
                    </button>
                ...
                <div id="registerForm" class="form-transition hidden">
                    <form on:submit|preventDefault={handleRegister}>
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center">
                                <input id="agreeTerms" name="agree-terms" type="checkbox" required
                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
        ...
        <div class="mt-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Why Choose QuizCraft?</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="bg-white bg-opacity-40 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-700">Create professional quizzes with our intuitive drag-and-drop interface</p>
                </div>
                <div class="text-center">
                    <div class="bg-white bg-opacity-40 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-indigo-600" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-700">Support for multiple choice, true/false, and open-ended questions</p>
                </div>
                <div class="text-center">
                    <div class="bg-white bg-opacity-40 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-indigo-600" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-gray-700">Track performance and get detailed insights on quiz results</p>
                </div>
            </div>
        </div>
    </div>
