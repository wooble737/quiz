...
<\/script> <style global="">/* global rules */
  body {
  ...
  }</style></div>`));function H(y){var r=M(),a=e(r),o=s(e(a),2),c=e(o),g=s(e(c),6),m=e(g),w=s(m,2);t(g),t(c),t(o);var u=s(o,6),x=e(u),z=s(e(x),4);t(x),t(u),t(a);var v=s(a,2),l=e(v),L=e(l);t(l);var p=s(l,4),b=e(p),d=s(e(b),2),C=e(d);t(d);var h=s(d,2),T=e(h);t(h),n(2),t(b),t(p),n(2),t(v),n(4),t(r),i("click",m,showAuthForms),i("click",w,scrollToFeatures),i("click",z,showAuthForms),i("click",L,showLanding),i("submit",C,f(handleLogin)),i("submit",T,f(handleRegister)),k(y,r)}export{H as component};
